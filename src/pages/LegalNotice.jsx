  ...
  return (
    <div className="max-w-4xl mx-auto py-8">
      ...
      <div className="bg-slate-900 border border-slate-800 p-8 flex flex-col gap-8 rounded-2xl shadow-2xl text-slate-300">
        ...
        <section>
          <h3 className="text-xl font-bold text-white mb-4 uppercase tracking-widest text-purple-400">1. Éditeur du site</h3>
        ...
        <section>
          <h3 className="text-xl font-bold text-white mb-4 uppercase tracking-widest text-purple-400">2. Hébergement</h3>
        ...
        <section>
          <h3 className="text-xl font-bold text-white mb-4 uppercase tracking-widest text-purple-400">3. Propriété intellectuelle</h3>
        ...
        <section>
          <h3 className="text-xl font-bold text-white mb-4 uppercase tracking-widest text-purple-400">4. Données personnelles</h3>
          <p className="text-slate-400">
        ...
        <section>
          <h3 className="text-xl font-bold text-white mb-4 uppercase tracking-widest text-purple-400">5. Cookies</h3>
          <p className="text-slate-400">
